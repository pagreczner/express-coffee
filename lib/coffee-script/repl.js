...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, merge, nodeREPL, path, replDefaults, requireUtility, updateSyntaxError, vm, _ref;
  ...
  module.exports = {
    start: function(opts) {
      var build, major, minor, repl, workingDir, _ref1;
      if (opts == null) {
        opts = {};
      }
