...
(function() {
  var fs, swaggerUtilityBaseObj, _;
  ...
  module.exports = {
    createFunctionHash: function(absoluteFilePath) {
      var fileCode, functionMap, lines, swaggerMapper, swaggerUtil;
      ...
      _.each(lines, (function(_this) {
        return function(line) {
          ...
          if (_this.isFunctionLine(line)) {
            ...
            return swaggerUtil.reset();
          }
        };
      })(this));
      return [this.getFileName(absoluteFilePath), functionMap, swaggerMapper];
    },
